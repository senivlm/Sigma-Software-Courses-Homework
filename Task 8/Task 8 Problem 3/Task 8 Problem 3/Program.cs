...
// products.txt - файл для наповнення даних з файлу.
// output in console.txt - приклад виводу даних в консоль, після наповнення даних з файлу.
// logs.txt - журнал помилок.
